/*
 ...
 Source Server         : Kikker Prod R - HOURLY
 Source Server Type    : MySQL
 Source Server Version : 80031 (8.0.31-google)
 Source Host           : 34.90.188.228:3306
...
) ENGINE=InnoDB AUTO_INCREMENT=195967053 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=8922 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=179257 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=267947458 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci
...
) ENGINE=InnoDB AUTO_INCREMENT=13925 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=59341 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `recalculated_hourly_usage` (
  ...
  KEY `idx_hourly_tariff_yearmonth_ean_date` (`year_month`,`ean`,`date`) USING BTREE,
  KEY `idx_hourly_tariff_ean_date_hour_isp` (`ean`,`date`,`hour_of_day`,`isp`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=61403086 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci
/*!50100 PARTITION BY RANGE (`year_month`)
(PARTITION p202309 VALUES LESS THAN (202310) ENGINE = InnoDB,
 PARTITION p202310 VALUES LESS THAN (202311) ENGINE = InnoDB,
 PARTITION p202311 VALUES LESS THAN (202312) ENGINE = InnoDB,
...
) ENGINE=InnoDB AUTO_INCREMENT=104561 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `waiting_delete_bigquery_ean` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55426 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
